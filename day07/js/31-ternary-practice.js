...
/*
pseudo class'lar HTML elemanlarının durumlarını hedeflerken (örneğin, ne zaman üzerine gelindiğinde veya tıklandığında), 
pseudo element'ler ise elemanların içeriğini biçimlendirmek veya içeriğe eklemek için kullanılır.
*/
